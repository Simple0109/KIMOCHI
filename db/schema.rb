...
ActiveRecord::Schema[7.0].define(version: 20_231_218_070_721) do # rubocop:disable Metrics/BlockLength
  ...
  create_table 'gives', force: :cascade do |t|
    ...
    t.index ['request_id'], name: 'index_gives_on_request_id'
  end
  ...
  create_table 'group_users', force: :cascade do |t|
    ...
    t.index %w[user_id group_id], name: 'index_group_users_on_user_id_and_group_id', unique: true
  ...
  create_table 'request_users', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[request_id user_id], name: 'index_request_users_on_request_id_and_user_id', unique: true
